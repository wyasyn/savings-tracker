...
CREATE TABLE "user" (
	...
	"country" text,
	"currency" text,
	"savings_channels" text[],
	"sacco_member" boolean DEFAULT false NOT NULL,
	"sacco_name" text,
...
ALTER TABLE "deposit" ADD CONSTRAINT "deposit_goal_id_goal_id_fk" FOREIGN KEY ("goal_id") REFERENCES "public"."goal"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
